    ...
    <div class="page-content" style="background-color: #ffffff;">
        ...
        <div class="form-container">
            ...
            <form action="<?php echo e(url('c_edit_room', $data->id)); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    <label>Título</label>
                    <input type="text" name="title" value="<?php echo e($data->room_title); ?>" maxlength="25" pattern="[A-Za-z\s]+" required readonly>
                </div>
                <div>
                    <label>Descripción</label>
                    <textarea name="description" maxlength="50" required readonly><?php echo e($data->description); ?></textarea>
                </div>
                <div>
                    <label>Precio</label>
                    <input type="number" name="price" value="<?php echo e($data->price); ?>" max="1000" required readonly>
                </div>
                <div>
                    <label>Automóvil</label>
                    <input type="text" name="room_type" value="<?php echo e($data->room_type); ?>" max="1000" required readonly>
                </div>
                <div>
                    <div>
                        <label>Pago</label>
                        <input type="text" name="wifi" value="<?php echo e($data->wifi); ?>" max="1000" required readonly>
                    </div>
                </div>
                <div>
                    <label>Imagen</label>
...
<?php /**PATH D:\tesis\tesis\tesis\resources\views/conductor/c_detalles.blade.php ENDPATH**/ ?>